...
@delete_object_property = (object, property) ->
  value = object[property] || null
  delete object[property]
  value

@object_without_properties = (object, properties) ->
  obj = $.extend({}, object)
  delete obj[property] for property in properties
  obj

@extract_keys = (object) -> key for key of object

@slice_object = (object, keys) ->
  obj = {}
...
@slice_object_and_remove = (object, keys) ->
  obj = {}

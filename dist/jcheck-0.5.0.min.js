...
return""+(this.options.field_prefix)+"["+(name)+"]"+(subparts);}else{return name;}};$.FormCheck.default_locale="en";$.FormCheck.Field=function(form,name,attribute){var _a,_b,_c;this.form_checker=form;this.field_name=name;this.attribute=attribute;this.live_notifiers=[":parent"];this.element=this.form_checker.form.find((":input[name='"+(name)+"']"));this.custom_label=null;if(this.form_checker.options.live_notifiers){_b=this.events_for_element();for(_a=0,_c=_b.length;_a<_c;_a++){(function(){var evt=_b[_a];return this.element[evt]((function(__this){var __func=function(e){this.form_checker.is_valid();return this.form_checker.dispatch_live_notifiers("notify",this.attribute,e,this.live_notifiers);};return(function(){return __func.apply(__this,arguments);});})(this));}).call(this);}}

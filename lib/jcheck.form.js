...
(function($) {
  $.FormCheck = (function() {
    ...
    FormCheck.prototype.dispatch_live_notifiers = function(callback, attribute, event, notifiers) {
      var current_notifiers, n, notifier, _i, _j, _len, _len2, _results;
      current_notifiers = [];
      ...
      _results = [];
      for (_j = 0, _len2 = current_notifiers.length; _j < _len2; _j++) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          if (this.options[type]) {
            _ref2 = this.options[type];
            _results2 = [];
            for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
              kind = _ref2[_j];
              _results2.push(this[type] = this.get_notifier(kind));
            }
            return _results2;
          }
        }).call(this));
    ...
    FormCheck.prototype.field = function(name) {
      var _base, _ref;
            if ((_ref = (_base = this.field_cache)[name]) != null) {
        _ref;
      } else {
  ...
  $.FormCheck.Field = (function() {
    function Field(form, name, attribute) {
      ...
      if (this.form_checker.options.live_notifiers) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          evt = _ref[_i];
          this.element[evt](__bind(function(e) {

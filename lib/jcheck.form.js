(function($) {
  ...
  $.FormCheck.prototype.setup_notifiers = function() {
    var _a, _b, _c, _d, _e, _f, _g, _h, kind;
    this.notifiers = (function() {
      _a = []; _c = this.options.notifiers;
      for (_b = 0, _d = _c.length; _b < _d; _b++) {
        kind = _c[_b];
        _a.push(new ($.FormCheck.find_notifier(kind))(this));
      }
      return _a;
    }).call(this);
    if (this.options.live_notifiers) {
      this.live_notifiers = (function() {
        _e = []; _g = this.options.live_notifiers;
        for (_f = 0, _h = _g.length; _f < _h; _f++) {
          kind = _g[_f];
          _e.push(new ($.FormCheck.find_notifier(kind))(this));
        }
        return _e;
      }).call(this);
      return this.live_notifiers;
    }
  };

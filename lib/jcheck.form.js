    ...
    $.FormCheck = (function() {
      ...
      FormCheck.prototype.parse_inline_validations = function() {
        ...
        return this.form.find(":input[data-validations]").each(function(index, element) {
          ...
          e = $(element);
          field_name = _this.parse_field_name(e);
          validations = _this.parse_validation_string(e.attr("data-validations"));
          return _this.validates(field_name, validations);
        });
      };
      ...
      FormCheck.prototype.is_valid = function(triggerNotifiers) {

...
(function($) {
  ...
  $.FormCheck.prototype.field = function(name) {
    this.field_cache[name] = (typeof this.field_cache[name] !== "undefined" && this.field_cache[name] !== null) ? this.field_cache[name] : new $.FormCheck.Field(this, this.field_name(name), name);
  ...
  $.FormCheck.Field = function(form, name, attribute) {
    ...
    if (this.form_checker.options.live_notifiers) {
      ...
      for (_a = 0, _c = _b.length; _a < _c; _a++) {
        (function() {
          var evt = _b[_a];
          return this.element[evt](__bind(function(e) {
  ...
  $.FormCheck.Field.prototype.value_for_checkbox = function() {
    return this.element.length > 1 ? $.makeArray(this.element.filter(":checked").map(function() {
      return $(this).val();

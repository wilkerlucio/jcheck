...
(function($) {
  ...
  $.FormCheck.Notifiers.NotificationDialog = function() {
    return $.FormCheck.Notifiers.DialogBase.apply(this, arguments);
  };
  ...
  $.FormCheck.Notifiers.TipBallons.prototype.focus = function(attribute) {
    return this.notify(attribute);
  };
  $.FormCheck.Notifiers.TipBallons.prototype.notify = function(attribute) {
    ...
    element = this.form.field(attribute).element;

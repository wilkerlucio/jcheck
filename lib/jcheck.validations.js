...
(function($) {
  ...
  $.FormCheck.Validator.create = function(name, object, base) {
    ...
    base = (typeof base !== "undefined" && base !== null) ? base : $.FormCheck.EachValidator;
    class_name = name.camelize() + "Validator";
    validator = function() {
      validator.__superClass__.constructor.apply(this, arguments);
    ...
    $.FormCheck.prototype[("validates_" + (name) + "_of")] = function() {
      var attributes;
      attributes = __slice.call(arguments, 0);
      return this.validates_with(validator, this.attributes_for_with(attributes));
    };
    return validator;
  };
  $.FormCheck.Validations.BlockValidator = function(options) {
    this.callback = delete_object_property(options, 'callback') || $.noop;
    $.FormCheck.Validations.BlockValidator.__superClass__.constructor.call(this, options);
    return this;
  };
  __extends($.FormCheck.Validations.BlockValidator, $.FormCheck.EachValidator);
  $.FormCheck.Validations.BlockValidator.prototype.validate_each = function(form, attribute, value) {
  ...
  $.FormCheck.Validations.LengthValidator.prototype.validate_each = function(form, attribute, value) {
    ...
    if (this.options["is"] && this.options["is"] !== value.length) {
      if ((typeof (_a = this.options["wrong_length"]) !== "undefined" && _a !== null)) {
        this.options["message"] = (typeof this.options["message"] !== "undefined" && this.options["message"] !== null) ? this.options["message"] : this.options["wrong_length"];
      }
    ...
    if (this.options["minimum"] && this.options["minimum"] > value.length) {
      if ((typeof (_b = this.options["too_short"]) !== "undefined" && _b !== null)) {
        this.options["message"] = (typeof this.options["message"] !== "undefined" && this.options["message"] !== null) ? this.options["message"] : this.options["too_short"];
      }
    ...
    if (this.options["maximum"] && this.options["maximum"] < value.length) {
      if ((typeof (_c = this.options["too_long"]) !== "undefined" && _c !== null)) {
        this.options["message"] = (typeof this.options["message"] !== "undefined" && this.options["message"] !== null) ? this.options["message"] : this.options["too_long"];
      }
  ...
  $.FormCheck.Validations.NumericalityValidator.prototype.validate_each = function(form, attribute, value) {
    ...
    for (check in _b) {
      if (!__hasProp.call(_b, check)) continue;
      val = _b[check];
      _a.push((function() {
  ...
  $.FormCheck.prototype.validates = function() {
    var _a, _b, attributes, current_options, defaults, kind, options, validations, validator;
    attributes = __slice.call(arguments, 0);
    ...
    _a = []; _b = validations;
    for (kind in _b) {
      if (!__hasProp.call(_b, kind)) continue;
      options = _b[kind];
      _a.push((function() {
        validator = $.FormCheck.find_validator(kind);
        current_options = $.extend({}, defaults);
        return validator ? this.validates_with(validator, $.extend(current_options, $.FormCheck.parse_validates_options(options))) : null;
      }).call(this));
    }
    return _a;
  };

...
(function($) {
  ...
  $.FormCheck.prototype.validates_each = function() {
    ...
    $.isFunction(options.attributes[options.attributes.length - 1]) ? (options.callback = attributes.pop()) : null;
  ...
  $.FormCheck.prototype.validates = function() {
    var _c, _d, attributes, current_options, defaults, kind, options, validations, validator;
    var _a = arguments.length, _b = _a >= 1;
    attributes = __slice.call(arguments, 0, _a - 0);
